...
> All personas must use this canonical severity scale when rating
> findings. Consistent classification enables meaningful panel
> consolidation.
...
| ------------ | ------------------------------------------- | ------------------------------------- |
| **Critical** | Production-breaking, data loss, or exploit | Must fix before any further progress |
| **High** | Significant degradation or security risk | Must fix before merge or deploy |
| **Medium** | Moderate quality or maintainability concern | Should fix in current cycle |
| **Low** | Minor improvement, no immediate risk | Consider fixing; document if deferred |
